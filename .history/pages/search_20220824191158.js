        ...
        <main className="flex">
          <section>
            ...
            <div className="w-full  px-2 py-5 sm:px-0">
              <Tab.Group>
                <Tab.List className="flex space-x-2  rounded-full b-2  p-4">
                  <>
                    <Tab
                      className={({ selected }) =>
                        classNames(
                          "w-20 rounded-full py-2.5  text-sm font-medium  text-black shadow-md ",
                          "ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-200 focus:outline-none focus:ring-2",
                          selected
                            ? "bg-white shadow-xl font-semibold"
                    ...
                    >
                      <div className="flex flex-col items-center ">
                        <img
                          ...
                          alt=""
                        />
                        <p className="text-xs text-gray-600">Omg</p>
                      </div>
                    </Tab>
                    ...
                    <Tab
                      className={({ selected }) =>
                        classNames(
                          "max-w-20 h-20 rounded-full py-2.5  text-sm font-medium  text-black shadow-md ",
                          "ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-200 focus:outline-none focus:ring-2",
                          selected
                            ? "bg-white shadow-xl font-semibold"
                            : "text-gray-500  hover:text-black"
                    ...
                    <Tab
                      className={({ selected }) =>
                        classNames(
                          "w-20 rounded-full py-2.5 text-sm font-medium  text-black shadow-md px-2",
                          "ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-200 focus:outline-none focus:ring-2",
                          selected
                            ? "bg-white shadow"
                            : "text-gray-500  hover:text-black"
                    ...
                    <Tab
                      className={({ selected }) =>
                        classNames(
                          "w-full rounded-full py-2.5 text-sm font-medium  text-black shadow-md px-2",
                          "ring-white ring-opacity-60 ring-offset-2 ring-offset-gray-200 focus:outline-none focus:ring-2",
                          selected
                            ? "bg-white shadow"
                            : "text-gray-500  hover:text-black"
