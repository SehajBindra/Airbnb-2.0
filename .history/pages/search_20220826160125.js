      ...
      <div className="">
        ...
        <main className="flex  ">
          <section className="flex-grow px-6 pt-16">
            ...
            <div className="px-2 mx-auto py-4 my-auto sm:w-[35rem] rounded-lg md:w-[45rem] sm:h-[25rem]  w-[25rem] h-[10rem] scrollbar-hide overflow-x-hidden lg:hidden">
              <Maps SearchResults={SearchResults} />
            </div>
          </section>

          <section className="hidden lg:inline-flex lg:w-[40rem] my-10 overflow-hidden scrollbar-hide ">
            <Maps SearchResults={SearchResults} />
          </section>
        </main>
        <Footer />
