      ...
      <div className="">
        ...
        <main className="flex  ">
          <section className="flex-grow px-6 pt-16">
            ...
            <div className="px-8 mx-auto py-4 my-auto sm:m-w-[50rem] rounded-lg md:w-[45rem] sm:h-[25rem]  w-[23rem] h-[25rem] scrollbar-hide overflow-x-hidden lg:hidden">
              <Maps SearchResults={SearchResults} />
            </div>
          </section>

          <section className="hidden lg:inline-flex lg:w-[40rem] my-20 overflow-hidden scrollbar-hide ">
            <Maps SearchResults={SearchResults} />
          </section>
        </main>
        <Footer />
