...
function Header() {
  return (
    <header className="sticky z-50 shadow-md top-0 sm:grid sm:grid-cols-3 bg-white p-5 md:px-5">
      {/* left */}
      <div className="hidden  relative md:inline-flexflex items-center h-10 cursor-pointer my-auto">
        <Image
          objectFit="contain"
          objectPosition="left"
          layout="fill"
      ...
      {/* center */}
      <div className=" flex  items-center flex-grow border-2 rounded-full p-3  sm:shadow-md ">
        <input
        ...
        />
        <MagnifyingGlassIcon className="hidden md:inline-flex h-8 w-8 text-white bg-red-400 rounded-full p-2 cursor-pointer" />
      </div>
