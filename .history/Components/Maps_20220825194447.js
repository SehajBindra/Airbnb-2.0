        ...
        <div key={result.long}>
          ...
          >
            <p
              ...
              className="cursor-pointer absolute text-red-400 text-2xl animate-bounce"
            >
              {" "}
              <img
                className="h-8 cursor-pointer"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7u_Yso86JVP6qPHU1UOPv002IKKjeGXgJTw&usqp=CAU"
                alt=""
              />
            </p>
          </Marker>
