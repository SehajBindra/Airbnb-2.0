...
function Header() {
  return (
    <header className="sticky z-50 shadow-md top-0 grid grid-cols-3 bg-white p-3 md:px-10">
      {/* left */}
      ...
      <div className=" flex  items-center flex-grow sm:border-2 sm:rounded-full p-3  sm:shadow-md ">
        ...
        />
        <MagnifyingGlassIcon className="hidden md:inline h-8 w-8 text-white bg-red-400 rounded-full p-2 cursor-pointer" />
      </div>
