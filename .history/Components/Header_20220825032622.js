  ...
  return (
    <header className="sticky z-50 shadow-md top-0 grid grid-cols-3 bg-white p-5 md:px-5">
      ...
      <div className="flex items-center justify-end text-gray-500 space-x-2 ml-4 ">
        <p className="hidden md:inline link ">Become a host</p>
      ...
      {searchInput && (
        <div className="flex flex-col col-span-3 mt-5  sm:mx-auto ">
          ...
          <div className="flex">
            ...
            <button
              onClick={search}
              className="flex-grow hover:shadow-2xl active:scale-90 transition duration-150 hover:bg-red-400 hover:text-white cursor-pointer px-4 py-2 rounded-xl   text-red-400"
            >
              Search
            </button>
          </div>
