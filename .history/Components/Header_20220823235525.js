  ...
  return (
    <header className="sticky z-50 shadow-md top-0 grid grid-cols-3 bg-white p-5 md:px-10">
      ...
      <div className=" flex  items-center flex-grow sm:border-2 sm:rounded-full p-3  sm:shadow-md ">
        ...
        />
        <MagnifyingGlassIcon className="hidden md:inline h-12 w-8 text-white bg-red-400 rounded-full p-4 cursor-pointer" />
      </div>

      {/* right */}
      <div className="flex items-center justify-end text-gray-500 space-x-4 mx-auto ">
