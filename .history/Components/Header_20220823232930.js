...
function Header() {
  return (
    <header className="sticky z-50 shadow-md top-0 grid grid-cols-3 bg-white p-5 md:px-10">
      ...
      {/* center */}
      <div className=" flex  border-2 rounded-md items-center sm:border-2 sm:rounded-full p-3  sm:shadow-md max-w-md">
        <input
          className=" sm:pl-4 focus-within:outline-none bg-transparent flex items-center flex-grow"
          type="text"
