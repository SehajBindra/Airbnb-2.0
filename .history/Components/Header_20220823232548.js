...
function Header() {
  return (
    <header className="sticky z-50 shadow-md top-0 grid grid-cols-3 bg-white p-5 md:px-10">
      ...
      {/* center */}
      <div className=" flex items-center border-2 rounded-full p-3  shadow-md max-w-md">
        <input
          className=" pl-4 focus-within:outline-none bg-transparent flex items-center flex-grow"
          type="text"
